...
Монтажёр видит назначенную ему производственную задачу. Поля менеджера и сценариста доступны
только для чтения; монтажёр изменяет только результат своей работы.
...
только три поля из последней таблицы и проверяет, что задача назначена текущему монтажёру.
