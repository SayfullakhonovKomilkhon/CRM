...
из трёх полей и доступен внутренним ролям при готовом согласованном исходнике.
...
менеджер и сценарист могут корректировать тот же результат в общей internal-role модели.
